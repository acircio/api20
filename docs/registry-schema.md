...
API20 v0.3 registry entries use a structured metadata schema for documenting x402-powered APIs.
...
Builder Code fields are research/planned metadata only. API20 does not attach Builder Codes to real settlement transactions.
