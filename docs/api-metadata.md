...
API20 documents payment and agent-oriented metadata for x402-powered APIs.
...
Sample 402 responses are available at [server.api20.xyz](https://server.api20.xyz).
