...
The current public version provides a web-based terminal simulation, documentation, registry preview, and schema exploration at [api20.xyz](https://api20.xyz).
